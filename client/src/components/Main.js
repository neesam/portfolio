        ...
        <div>
            ...
            <div>
                <div style={{background:'rgb(238,174,202)', background: 'radial-gradient(circle, rgba(238,174,202,1) 0%, rgba(148,187,233,1) 100%)', display: 'flex', gap: '6rem', width: 'fit-content', padding: '2rem', borderRadius: '1rem', boxShadow: '2px 2px 4px 2px gray'}}>
                    <div>
                        <h4 style={{width: '20rem', position: 'relative', fontSize: '30px', color: 'white', textShadow: '1px 1px 1px gray'}}><a target="_blank" href="//www.broken-record.net" style={{color: 'white', textDecoration: 'none'}}>broken record</a></h4>
        ...
        <h3 style={{gridRow: '4', gridColumn: '2', fontSize: '45px', color: 'white', textShadow: '2px 2px 2px black', lineHeight: '.5rem', marginTop: '5rem'}}>Skills</h3>
            ...
            <div>
              ...
              <h3>
                ...
                <p style={{marginTop: '2rem'}}>
                  For the past two years, I've helped local businesses increase their visibility online through search engine optimization. I spend my days revising content and implementing strategies for a wide range of businesses; plumbers, therapists - you name it.
                </p>
                <p>
